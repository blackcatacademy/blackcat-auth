...
use BlackCat\Auth\PasswordReset\PasswordResetToken;
...
final class PasswordResetTokenTest extends TestCase
{
    ...
    {
        self::assertNull(PasswordResetToken::parse(''));
        self::assertNull(PasswordResetToken::parse('no-dot'));
        self::assertNull(PasswordResetToken::parse('short.short'));
        self::assertNull(PasswordResetToken::parse(str_repeat('a', 12) . '.not*base64'));
    }
}
